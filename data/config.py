...
#ddir = os.path.join('/Users/lixiaofan/Desktop/RFBNet-master',"data/VOCdevkit/")
ddir = os.path.join('/hy-tmp/dppm', "data/VOCdevkit/")

# note: if you used our download scripts, this should be right
VOCroot = ddir # path to VOCdevkit root dir
#COCOroot = "data/COCO/"
COCOroot = "/shared-public/data/coco2017/coco2017"
